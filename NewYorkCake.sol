...
//
// $NewYork proposes an innovative feature in its contract.
// Hold NYCake and get rewarded in Cake on every transaction!
// 
// https://nycake.app/
// https://t.me/newyorkcake
// https://twitter.com/nycake_bsc
// https://medium.com/@newyorkcake
...
contract NewYorkCake is ERC20, Ownable {
    ...
    address public _marketingWalletAddress = 0x8a2aF3EA46C95e80831d01E9DCBe087624166126;
    ...
    constructor() public ERC20("NewYork Cake", "NYCAKE") {
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 0 && newValue <= 500000, "NYCAKE: gasForProcessing must be between 200,000 and 500,000");
...
contract NYCAKEDividendTracker is Ownable, DividendPayingToken {
    ...
    constructor() public DividendPayingToken("NYCAKE_Dividen_Tracker", "NYCAKE_Dividend_Tracker") {
    	claimWait = 3600;
